<template>
    <v-row>
        ...
        <!-- camera -->
        <v-col cols="12" md="6">
            <QrcodeStream :camera="camera" :track="paintOutline" @init="onInit" @decode="onDecode">
            </QrcodeStream>
        </v-col>
        ...
        <v-col cols="12" md="6">
            <v-card class="mx-auto">
                ...
                <v-card-actions>
                    <v-btn color="default" class="ml-4" @click="clearHistory">
                        <v-icon left>
                            mdi-delete
                        </v-icon>
                        Clear All
                ...
                <v-card-text>
                    <v-list shaped max-height="80vh" class="overflow-y-auto">
                        <v-list-item-group>
                            <template v-for="(item, i) in history">
                                <v-list-item :key="`item-${i}`" :value="item" active-class="deep-purple--text"
